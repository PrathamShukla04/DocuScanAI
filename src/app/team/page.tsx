...
export default function TeamPage() {
  const testimonials = [
    ...
    {
      quote:
        "ClauseLogic’s backend architecture was designed for speed, scalability, and seamless AI integration.",
  ...
  content: (
    <div className="space-y-4">
      ...
      <p className="text-sm text-neutral-300 dark:text-neutral-200">
        ...
        🔗 <a href="https://www.linkedin.com/in/pratham-shukla-35b65a330/" target="_blank" className="underline text-cyan-400">LinkedIn</a><br />
        📞 +91 8187930650
      </p>
    </div>
  ),
...
,
  ...
  content: (
    <div className="space-y-4">
      ...
      <p className="text-sm text-neutral-300 dark:text-neutral-200">
        ...
        🔗 <a href="https://www.linkedin.com/in/ParikshitJaiswal" target="_blank" className="underline text-cyan-400">LinkedIn</a> 
        <br/>📞 +91 8604734172
      </p>
    </div>
  ),
  ...
  content: (
    <div className="space-y-4">
      ...
      <p className="text-sm text-neutral-300 dark:text-neutral-200">
        My current focus lies in **Machine Learning**, **Data Science**, and **Backend Development**, where I’m actively learning and applying concepts like DSA, DBMS, and OOP. I also possess foundational experience in full-stack development and enjoy turning complex challenges into impactful solutions.
      </p>
      <p className="text-sm text-neutral-300 dark:text-neutral-200">
      ...
      <p className="text-sm text-neutral-300 dark:text-neutral-200">
        ...
        🔗 <a href="https://www.linkedin.com/in/rifa-rafiq-636218377/" target="_blank" className="underline text-cyan-400">LinkedIn</a><br />
...
,
  ...
  content: (
    <div className="space-y-4">
      ...
      <p className="text-sm text-neutral-300 dark:text-neutral-200">
        As a Core Member of the College Robotics Club and a Team Programmer in **Robocon 2025 (Qualified Nationals)**, I’ve demonstrated my passion for teamwork, leadership, and pushing boundaries in real-world competitions.
      </p>
      <p className="text-sm text-neutral-300 dark:text-neutral-200">
        📧 <a href="mailto:pratyakshagupta410@gmail.com" className="underline text-cyan-400">pratyakshagupta410@gmail.com</a><br />
        
        🔗 <a href="https://www.linkedin.com/in/pratyaksha-gupta-354b2133b/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" className="underline text-cyan-400">LinkedIn</a><br />
        📞 +91 8368104343
      </p>
    </div>
  ),
